...
const EXTERNAL_API = "http://localhost:3005/books"
export const retriveBooks =createAsyncThunk("book/getBooks" , async(_ ,thunkAPI)=>{
...
export  const InsertNewBook =createAsyncThunk("book/insertBook",async(newBook ,thunkAPI)=>{
...
const bookSlice = createSlice({
    ...
    extraReducers : {
        //Get Book List
        [retriveBooks.pending]:(state , action ) =>{
        ...
        [retriveBooks.rejected]:(state , action )=>{
            state.isLoading = false 
